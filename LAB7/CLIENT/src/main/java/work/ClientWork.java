    ...
    public void getAnswer(Socket socket) throws IOException, ClassNotFoundException {
        ...
        switch (answer) {
            ...
            case "Такой пользователь уже существует. Перезагрузите клиент и авторизуйтесь.":
                System.out.println("Такой пользователь уже существует. Перезагрузите клиент и авторизуйтесь.");
                System.exit(0);
                break;
            case "Введён неверный логин или пароль. У вас нет полномочий на сервере. Перезагрузите клиент и авторизуйтесь.":
                System.out.println("Введён неверный логин или пароль. У вас нет полномочий на сервере. Перезагрузите клиент и авторизуйтесь.");
                System.exit(0);
                break;
